...
public class Manual {
    ...
    public void showInstructions(){
        ...
        System.out.println("ezeket a szavakat kell szóközzel elválasztva a konzolba beírni, majd Enter megnyomásával a parancsot ellenőrizni");
        System.out.println("A '[szám]' helyére bármilyen egész számot lehet beírni");
        ...
        System.out.println("Egy csempén álló panda átlép egy másik csempére, ami semilyen egyéb tulajdonsággal nem rendelkezik");
        ...
        System.out.println("Egy csempén álló panda átlép egy törött csempére.");
        ...
        System.out.println("Egy csempén álló orangután átlép egy másik csempére, ami semilyen egyéb tulajdonsággal nem rendelkezik");
        ...
        System.out.println("Egy csempén álló orangután átlép egy törött csempére.");

        System.out.println(">orangutan step exit");
        System.out.println("Egy csempén álló orangután átlép a kijáratra");
        ...
        System.out.println("A játékgép csilingel egyet, amitől a mellette lévő panda ugrik egyet");
